...
if all_packet_arrival_time[0][-1] >= video_duration + initial_buffers:
    ...
    if ideal_condition == False:
        ...
        tptest = [(all_packet_size[0][2 * i + 8] + all_packet_size[0][2 * i + 7] + all_packet_size[0][2 * i + 6] + all_packet_size[0][2 * i + 5] + all_packet_size[0][2 * i + 4] + all_packet_size[0][2 * i + 3] + all_packet_size[0][2 * i + 2] + all_packet_size[0][2 * i + 1]) / (all_packet_arrival_time[0][2 * i + 8] - all_packet_arrival_time[0][2 * i]) for i in range(int(total_frame_number) - 1)]
